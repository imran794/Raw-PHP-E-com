...
if (isset($_GET['status'])) {
   ...
   $singleid =  $prodatas['cat_id'];
   $related_products = $obj->Related_Products($singleid);
            ...
            <div id="main-content" class="main-content">
                    ...
                    <div class="sumary-product single-layout">
                        <div class="media">
                            <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                                <li><img src="admin/uploadimage/<?php echo $pro['pro_img']; ?>" alt="" width="500" height="500"></li>
                            </ul>
                        ...
                        <div class="product-attribute">
                            ...
                            <div class="rating">
                                ...
                                <b class="category">By: <?php echo $pro['cat_name']; ?></b>
                            </div>
                            <span class="sku">sku: <?php echo $pro['Pro_id']; ?> </span>
                            <p class="excerpt"><?php echo $pro['pro_des']; ?></p>
                            <div class="price">
                                <ins><span class="price-amount"><span class="currencySymbol">£</span><?php echo $pro['pro_price']; ?></span></ins>
                            </div>
                ...
                <div class="product-related-box single-layout">
                    ...
                    <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":5, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}]}'>
                       ...
                       <?php while($rel_pro=mysqli_fetch_assoc($related_products)) { ?>
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="#" class="link-to-product">
                                        <img src="admin/uploadimage/<?php echo $rel_pro['pro_img']; ?>" alt="dd" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories"><?php echo $rel_pro['cat_name']; ?></b>
                                    <h4 class="product-title"><a href="#" class="pr-name"><?php echo $rel_pro['pro_name']; ?></a></h4>
                                    <div class="price">
                                        <ins><span class="price-amount"><span class="currencySymbol">£</span><?php echo $rel_pro['pro_price']; ?></span></ins>
